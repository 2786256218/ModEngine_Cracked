...
function monoform_miExpandAllClick(sender)
  --if messageDialog(translate("Are you sure you wish to expand the whole tree? This can take a while and Cheat Evolution may look like it has crashed (It has not)"), mtConfirmation, mbYes, mbNo)==mrYes then
